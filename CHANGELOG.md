...
- `gilgal regress <CONTRATO> "<frase do balcão>"` marks the contract `INCOMPLETE`, records the promoted SHA/contract/human observation in Memory, blocks promotion until fresh `check`/`ok`, and never moves STABLE or rolls back automatically.
